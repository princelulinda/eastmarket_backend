...
export type Vendor = {
  ...
  main_products: Maybe<Scalars['String']['output']>;
  employee_count: Maybe<Scalars['String']['output']>;
  social_links: Maybe<Scalars['JSON']['output']>;
  is_verified: Scalars['Boolean']['output'];
  response_rate: Maybe<Scalars['Int']['output']>;
  response_time: Maybe<Scalars['String']['output']>;
  admins: Array<Maybe<VendorAdmin>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  order_link: Maybe<Array<Maybe<LinkMarketplaceVendorOrderOrder>>>;
  orders: Maybe<Array<Maybe<Order>>>;
  product_link: Maybe<Array<Maybe<LinkMarketplaceVendorProductProduct>>>;
...
export type MessageSenderTypeEnum =
  | 'customer'
  | 'vendor';
...
export type AppNotificationRecipientTypeEnum =
  | 'customer'
  | 'vendor';

export type AppNotificationTypeEnum =
  | 'new_message'
  | 'new_order'
  | 'order_status'
  | 'order_shipped'
...
export type AppNotification = {
  ...
  recipient_type: AppNotificationRecipientTypeEnum;
...
export type ShortVideoStatusEnum =
  | 'draft'
  | 'published'
  | 'archived';
...
export type OpeninaryAsset = {
  __typename?: 'OpeninaryAsset';
  id: Scalars['ID']['output'];
...
export type Product = {
  ...
  vendor_link: Maybe<LinkMarketplaceVendorProductProduct>;
  vendor: Maybe<Vendor>;
};
...
export type Order = {
  ...
  vendor_link: Maybe<LinkMarketplaceVendorOrderOrder>;
  vendor: Maybe<Vendor>;
};
...
export type LinkMarketplaceVendorOrderOrder = {
  __typename?: 'LinkMarketplaceVendorOrderOrder';
  vendor_id: Scalars['String']['output'];
  order_id: Scalars['String']['output'];
  vendor: Maybe<Vendor>;
  order: Maybe<Order>;
...
export type LinkMarketplaceVendorProductProduct = {
  __typename?: 'LinkMarketplaceVendorProductProduct';
  vendor_id: Scalars['String']['output'];
  product_id: Scalars['String']['output'];
  vendor: Maybe<Vendor>;
  product: Maybe<Product>;
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    video_save: VideoSave
    video_saves: VideoSave
    openinary_asset: OpeninaryAsset
    openinary_assets: OpeninaryAsset
    review: Review
    reviews: Review
    ...
    vendor_order: LinkMarketplaceVendorOrderOrder
    vendor_product: LinkMarketplaceVendorProductProduct
  }
}